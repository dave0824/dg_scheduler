        ...
        <a-row :gutter="48">
          <a-col :md="8" :sm="24">
            <a-form-item label="ip地址" >
              <a-input placeholder="" v-model="updateFrom.ip"/>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
          ...
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="跟新人">
                <a-input style="width: 100%" v-model="updateFrom.updatePerson"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
    ...
    >
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          >
            <a-input-number  v-model="createForm.ip"/>
          </a-form-item>
          <a-form-item
            label="接口ID"
            :labelCol="labelCol"
