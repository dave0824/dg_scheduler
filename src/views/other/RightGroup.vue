        ...
        <a-row :gutter="48">
          <a-col :md="8" :sm="24">
            <a-form-item label="规则编号" >
              <a-input placeholder="" v-model="updateFrom.no"/>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
          ...
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="客户端KEY">
                <a-input style="width: 100%" v-model="updateFrom.description"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
    ...
    >
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          >
            <a-input-number  v-model="createForm.no"/>
          </a-form-item>
          <a-form-item
            label="客户端KEY"
            :labelCol="labelCol"
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
          >
            <a-input-number v-model="createForm.callNo"/>
          </a-form-item>
          <a-form-item
            label="状态"
            :labelCol="labelCol"
