    ...
    >
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          >
            <a-input-number  v-model="createForm.serveModelId"/>
          </a-form-item>
          <a-form-item
            label="服务模块名称"
            :labelCol="labelCol"
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
          >
            <a-input v-model="createForm.protocol"/>
          </a-form-item>
          <a-form-item
            label="权重"
            :labelCol="labelCol"
            :wrapperCol="wrapperCol"
          >
            <a-input-number v-model="createForm.weight"/>
          </a-form-item>
          <a-form-item
            label="状态"
            :labelCol="labelCol"
