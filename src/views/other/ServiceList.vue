  ...
  <a-card :bordered="false">
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            <a-col :md="8" :sm="24">
              <a-form-item label="域主键" >
                <a-input placeholder="" v-model="updateFrom.fieldNo"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
            ...
            <template v-if="advanced">
              <a-col :md="8" :sm="24">
                <a-form-item label="域名称">
                  <a-input style="width: 100%" v-model="updateFrom.fieldName"/>
                </a-form-item>
              </a-col>
              <a-col :md="8" :sm="24">
    ...
    >
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          >
            <a-input-number  v-model="createForm.fieldNo"/>
          </a-form-item>
          <a-form-item
            label="服务名称"
            :labelCol="labelCol"
            :wrapperCol="wrapperCol"
          >
            <a-input v-model="createForm.serviceName"/>
          </a-form-item>
          <a-form-item
            label="服务地址"
            :labelCol="labelCol"
          ...
          <a-form-item
            ...
            :wrapperCol="wrapperCol"
          >
            <a-input v-model="createForm.serviceDescription"/>
          </a-form-item>
          <a-form-item
            label="状态"
            :labelCol="labelCol"
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          scopedSlots: { customRender: 'serviceDescription' }
        },
        {
          title: '是否删除',
          dataIndex: 'isDel',
