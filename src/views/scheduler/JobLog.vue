      ...
      <a-form layout="inline">
        <a-row :gutter="48">
          ...
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
             <a-form-item label="作业触发状态">
              <a-input style="width: 100%" v-model="updateFrom.jobTriggerState"/>
             </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: '作业触发状态',
          dataIndex: 'jobTriggerState',
          scopedSlots: { customRender: 'jobTriggerState' }
        },
        {
          title: '作业触发时间',
          dataIndex: 'jobGroup',
          scopedSlots: { customRender: 'jobTriggerTime' }
        },
        {
          title: '作业处理状态',
          dataIndex: 'jobHandleState',
          scopedSlots: { customRender: 'jobHandleState' }
        },
        {
          title: '作业处理消息',
          dataIndex: 'jobHandleMsg',
          scopedSlots: { customRender: 'jobHandleMsg' }
        },
        {
          title: '作业处理时间',
          dataIndex: 'jobHandleTime',
          scopedSlots: { customRender: 'jobHandleTime' }
        },
        {
          title: '作业处理完成时间',
          dataIndex: 'jobHandleFinishTime',
          scopedSlots: { customRender: 'jobHandleFinishTime' }
        },
        {
          title: '创建人',
