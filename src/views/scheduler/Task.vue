        ...
        <a-row :gutter="48">
          <a-col :md="8" :sm="24">
            <a-form-item label="任务ID" >
              <a-input placeholder="" v-model="updateFrom.taskId"/>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="任务名称">
              <a-input style="width: 100%" v-model="updateFrom.taskName"/>
            </a-form-item>
          </a-col>
          <template v-if="advanced">
            <a-col :md="8" :sm="24">
              <a-form-item label="任务应用名">
                <a-input style="width: 100%" v-model="updateFrom.taskAppName"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
    ...
    >
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          >
            <a-input v-model="createForm.taskName"/>
          </a-form-item>
          <a-form-item
            label="任务编码"
            :labelCol="labelCol"
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: '任务组编码',
          dataIndex: 'taskGroupCode',
          scopedSlots: { customRender: 'taskGroupCode' }
        },
        {
          title: '任务路径',
          dataIndex: 'taskPath',
          scopedSlots: { customRender: 'taskPath' }
        },
        {
          title: '任务方法',
          dataIndex: 'taskMethod',
          scopedSlots: { customRender: 'taskMethod' }
        },
        {
          title: '任务方式',
          dataIndex: 'taskCategory',
          scopedSlots: { customRender: 'taskCategory' }
        },
        {
          title: '是否分配',
          dataIndex: 'isAssignment',
          scopedSlots: { customRender: 'isAssignment' }
        },
        {
          title: '创建人',
