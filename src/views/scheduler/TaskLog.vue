    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title: '状态描述信息',
          dataIndex: 'taskMsg',
          scopedSlots: { customRender: 'taskMsg' }
        },
        {
          title: '任务状态',
        ...
        {
          title: '任务处理时间',
          dataIndex: 'taskHandleTime',
          scopedSlots: { customRender: 'taskHandleTime' }
        },
        {
          title: '任务完成时间',
          dataIndex: 'taskFinishTime',
          scopedSlots: { customRender: 'taskFinishTime' }
        },
        {
          title: '创建人',
